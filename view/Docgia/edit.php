        ...
        <div class="row">
            ...
            <div class="col-md-8 ms-auto me-auto">
                ...
                <form class="row g-3 needs-validation" method="post" action="" novalidate>
                    <div class="col-md-12">
                        <label for="validationCustom01" class="form-label">Tên độc  gỉa</label>
                    ...
                    <div>
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="gioitinh" id="inlineRadio1" <?php if(isset($_POST['gioitinh']) && $_POST['gioitinh'] == 'Nam') {echo "checked";};?> value="Nam">
                            <label class="form-check-label" for="inlineRadio1">Nam</label>
                        </div>


                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="gioitinh" id="inlineRadio2" <?php if(isset($_POST['gioitinh']) && $_POST['gioitinh'] == 'Nữ') {echo "checked";};?> value="Nữ">
